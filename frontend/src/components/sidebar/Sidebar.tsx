...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-[260px] flex-col border-r border-surface-border bg-surface ${
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-5">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold text-gray-100">DevPulse</span>
          </div>
          {isMobile && (
            <button
              onClick={closeSidebar}
        ...
        <div className="border-t border-surface-border p-4">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="rounded-lg p-2 text-gray-500 transition-colors hover:bg-surface-lighter hover:text-gray-300"
              title="Выйти"
            >
              <LogOut size={18} />
            </button>
